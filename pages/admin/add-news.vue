            ...
            <div class="col-12">
               ...
               <b-form class="row">
                  ...
                  <div class="col-md-3 px-4">
                     <img :src="news.image" :alt="news.subject" v-if="news.image" style="max-height: 60px;">
                  ...
                  <div class="col-12 mt-4">
                     <div class="row">
                        <div class="col-12 col-md-6 m-auto">
                           <b-button class="col-12" type="button" @click="saveNews" squared size="lg" variant="primary">Kaydet</b-button>
                        </div>
                     </div>                     
                  </div>
               </b-form>
      ...
      methods:{
         saveNews(){
            ...
            if(_this.news.subject != '' && _this.news.description != '' && _this.news.short_description != '' && _this.news.category_id != '')
            {
               ...
               _this.$store.dispatch('postService' , {"data":_this.news , "urlParameter":"/api/v1/news/add" , "token": _this.token})
               .then(response => {
